    ...
    <ThemedView style={[styles.container, { backgroundColor: palette.background }]}>
      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <View>
            <ThemedText style={[styles.title, { color: palette.text }]}>Inventory</ThemedText>
            <ThemedText style={[styles.subtitle, { color: palette.muted }]}>Products and pricing</ThemedText>
          </View>
          <Pressable
        ...
        {filtered.length === 0 && !isLoading ? (
          <ThemedText style={[styles.emptyText, { color: palette.muted }]}>No products yet.</ThemedText>
        ) : (
          <FlatList
            data={filtered}
            ...
            renderItem={({ item }) => (
              ...
              >
                <View style={[styles.imagePlaceholder, { backgroundColor: palette.surfaceAlt, borderColor: palette.border }]}>
                  <ThemedText style={[styles.qtyBadge, { color: palette.muted }]}>QTY</ThemedText>
                </View>
                ...
                <ThemedText numberOfLines={1} style={[styles.metaText, { color: palette.muted }]}
                >
                  {item.barcode}
                </ThemedText>
